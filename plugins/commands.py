# Don't Remove Credit Tg - @VJ_Botz# Subscribe YouTube Channel For Amazing Bot https://youtube.com/@Tech_VJ
...
from utils import is_subscribed, verify_user, check_token, check_verification, get_token
from config import *
import re
import json
import base64
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            title = '@SA_Bots  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
